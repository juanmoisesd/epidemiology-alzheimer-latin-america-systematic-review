# Contributing to Epidemiology of Alzheimer in Latin America: Systematic Review Dataset

Thank you for your interest in contributing to **Epidemiology of Alzheimer in Latin America: Systematic Review Dataset**!
...
Open an [Issue](https://github.com/juanmoisesd/epidemiology-alzheimer-latin-america-systematic-review/issues) describing:
...
```bibtex
@misc{delaserna_epidemiology_alzheimer_latin_america_systematic_review,
  author    = {de la Serna Tuya, Juan Moisés},
  title     = {Epidemiology of Alzheimer in Latin America: Systematic Review Dataset},
  year      = {2024},
  publisher = {GitHub},
...
*Questions? Contact via [GitHub Issues](https://github.com/juanmoisesd/epidemiology-alzheimer-latin-america-systematic-review/issues).*
